...
const Home = () => {
      ...
      const reviewCode = async (
        ...
        try {
          ...
          setInp(code)
          let message = response.data || 'No review received.';
          setReview(message);
          setCode('')
        } catch (error) {
      ...
      <div className='h-[420px] overflow-y-scroll p-10 dark:text-white'>
          {!review ? <Solvinger /> : (<>
            <div className='flex flex-col items-end mb-3'>
              ...
              <div className='w-full max-w-2xl p-4 border rounded-lg shadow-sm bg-blue-900/30 dark:bg-gray-100/30 dark:text-white '><MarkdownRenderer content={inp} /></div>
            </div>
